The PayPal Permissions SDK C#.NET Class Library project contains the PayPal Permissions Stubs.
...
The PayPal Permissions SDK
--------------------------------
*	The PayPal Permissions SDK enables you to request and obtain authorization to make API calls and take action on behalf of your customers.

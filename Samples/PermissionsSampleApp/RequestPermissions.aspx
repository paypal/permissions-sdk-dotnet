<%@ Page Language="C#" AutoEventWireup="true" Codebehind="RequestPermissions.aspx.cs"
    Inherits="PermissionsSampleApp.RequestPermissions" %>
...
<body>
    ...
    <h2>
        RequestPermissions API Test Page</h2>
    <form id="form1" runat="server" action="PermissionsHandler.ashx">
        ...
        <div class="params">
            ...
            <div class="param_value">
                <input type="text" id="callback" name="callback" size="60" value="<%=returnURL%>" /><br />
            </div>
        </div>
        <div class="params">
            <div class="param_name">
            ...
            <div class="param_value">
                ...
                <input type="checkbox" name="api" value="REFUND" />
                REFUND<br />
                ...
                <input type="checkbox" name="api" value="MANAGE_PENDING_TRANSACTION_STATUS" />MANAGE_PENDING_TRANSACTION_STATUS<br />
                <input type="checkbox" name="api" value="RECURRING_PAYMENT_REPORT" />RECURRING_PAYMENT_REPORT<br />
                <input type="checkbox" name="api" value="EXTENDED_PRO_PROCESSING_REPORT" />EXTENDED_PRO_PROCESSING_REPORT<br />
                <input type="checkbox" name="api" value="EXCEPTION_PROCESSING_REPORT" />EXCEPTION_PROCESSING_REPORT<br />
                <input type="checkbox" name="api" value="ACCOUNT_MANAGEMENT_PERMISSION" />ACCOUNT_MANAGEMENT_PERMISSION<br />
